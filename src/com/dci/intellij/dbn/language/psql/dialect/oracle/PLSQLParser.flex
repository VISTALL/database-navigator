...
"lock" {return tt.getKeywordTokenType(139);}
"log" {return tt.getKeywordTokenType(140);}
"loop" {return tt.getKeywordTokenType(141);}
"main" {return tt.getKeywordTokenType(142);}
"matched" {return tt.getKeywordTokenType(143);}
"maxvalue" {return tt.getKeywordTokenType(144);}
"mean_squares_between" {return tt.getKeywordTokenType(145);}
"mean_squares_within" {return tt.getKeywordTokenType(146);}
"measures" {return tt.getKeywordTokenType(147);}
"member" {return tt.getKeywordTokenType(148);}
"merge" {return tt.getKeywordTokenType(149);}
"minus" {return tt.getKeywordTokenType(150);}
"minute" {return tt.getKeywordTokenType(151);}
"minvalue" {return tt.getKeywordTokenType(152);}
"mlslabel" {return tt.getKeywordTokenType(153);}
"mode" {return tt.getKeywordTokenType(154);}
"model" {return tt.getKeywordTokenType(155);}
"month" {return tt.getKeywordTokenType(156);}
"multiset" {return tt.getKeywordTokenType(157);}
"name" {return tt.getKeywordTokenType(158);}
"nan" {return tt.getKeywordTokenType(159);}
"natural" {return tt.getKeywordTokenType(160);}
"naturaln" {return tt.getKeywordTokenType(161);}
"nav" {return tt.getKeywordTokenType(162);}
"nchar_cs" {return tt.getKeywordTokenType(163);}
"new" {return tt.getKeywordTokenType(164);}
"next" {return tt.getKeywordTokenType(165);}
"nextval" {return tt.getKeywordTokenType(166);}
"nocopy" {return tt.getKeywordTokenType(167);}
"nocycle" {return tt.getKeywordTokenType(168);}
"not" {return tt.getKeywordTokenType(169);}
"notfound" {return tt.getKeywordTokenType(170);}
"nowait" {return tt.getKeywordTokenType(171);}
"null" {return tt.getKeywordTokenType(172);}
"nulls" {return tt.getKeywordTokenType(173);}
"number_base" {return tt.getKeywordTokenType(174);}
"ocirowid" {return tt.getKeywordTokenType(175);}
"of" {return tt.getKeywordTokenType(176);}
"on" {return tt.getKeywordTokenType(177);}
"one_sided_prob_or_less" {return tt.getKeywordTokenType(178);}
"one_sided_prob_or_more" {return tt.getKeywordTokenType(179);}
"one_sided_sig" {return tt.getKeywordTokenType(180);}
"only" {return tt.getKeywordTokenType(181);}
"opaque" {return tt.getKeywordTokenType(182);}
"open" {return tt.getKeywordTokenType(183);}
"operator" {return tt.getKeywordTokenType(184);}
"option" {return tt.getKeywordTokenType(185);}
"or" {return tt.getKeywordTokenType(186);}
"order" {return tt.getKeywordTokenType(187);}
"organization" {return tt.getKeywordTokenType(188);}
"others" {return tt.getKeywordTokenType(189);}
"out" {return tt.getKeywordTokenType(190);}
"outer" {return tt.getKeywordTokenType(191);}
"over" {return tt.getKeywordTokenType(192);}
"package" {return tt.getKeywordTokenType(193);}
"parallel_enable" {return tt.getKeywordTokenType(194);}
"partition" {return tt.getKeywordTokenType(195);}
"pctfree" {return tt.getKeywordTokenType(196);}
"phi_coefficient" {return tt.getKeywordTokenType(197);}
"positive" {return tt.getKeywordTokenType(198);}
"positiven" {return tt.getKeywordTokenType(199);}
"power" {return tt.getKeywordTokenType(200);}
"pragma" {return tt.getKeywordTokenType(201);}
"preceding" {return tt.getKeywordTokenType(202);}
"present" {return tt.getKeywordTokenType(203);}
"prior" {return tt.getKeywordTokenType(204);}
"private" {return tt.getKeywordTokenType(205);}
"procedure" {return tt.getKeywordTokenType(206);}
"public" {return tt.getKeywordTokenType(207);}
"raise" {return tt.getKeywordTokenType(208);}
"range" {return tt.getKeywordTokenType(209);}
"rank" {return tt.getKeywordTokenType(210);}
"read" {return tt.getKeywordTokenType(211);}
"record" {return tt.getKeywordTokenType(212);}
"ref" {return tt.getKeywordTokenType(213);}
"reference" {return tt.getKeywordTokenType(214);}
"regexp_like" {return tt.getKeywordTokenType(215);}
"release" {return tt.getKeywordTokenType(216);}
"remainder" {return tt.getKeywordTokenType(217);}
"replace" {return tt.getKeywordTokenType(218);}
"restrict_references" {return tt.getKeywordTokenType(219);}
"return" {return tt.getKeywordTokenType(220);}
"returning" {return tt.getKeywordTokenType(221);}
"reject" {return tt.getKeywordTokenType(222);}
"reverse" {return tt.getKeywordTokenType(223);}
"right" {return tt.getKeywordTokenType(224);}
"rnds" {return tt.getKeywordTokenType(225);}
"rnps" {return tt.getKeywordTokenType(226);}
"rollback" {return tt.getKeywordTokenType(227);}
"rollup" {return tt.getKeywordTokenType(228);}
"row" {return tt.getKeywordTokenType(229);}
"rowcount" {return tt.getKeywordTokenType(230);}
"rownum" {return tt.getKeywordTokenType(231);}
"rows" {return tt.getKeywordTokenType(232);}
"rowtype" {return tt.getKeywordTokenType(233);}
"rules" {return tt.getKeywordTokenType(234);}
"sample" {return tt.getKeywordTokenType(235);}
"save" {return tt.getKeywordTokenType(236);}
"savepoint" {return tt.getKeywordTokenType(237);}
"scn" {return tt.getKeywordTokenType(238);}
"second" {return tt.getKeywordTokenType(239);}
"seed" {return tt.getKeywordTokenType(240);}
"segment" {return tt.getKeywordTokenType(241);}
"select" {return tt.getKeywordTokenType(242);}
"separate" {return tt.getKeywordTokenType(243);}
"sequential" {return tt.getKeywordTokenType(244);}
"serializable" {return tt.getKeywordTokenType(245);}
"serially_reusable" {return tt.getKeywordTokenType(246);}
"set" {return tt.getKeywordTokenType(247);}
"sets" {return tt.getKeywordTokenType(248);}
"share" {return tt.getKeywordTokenType(249);}
"siblings" {return tt.getKeywordTokenType(250);}
"sig" {return tt.getKeywordTokenType(251);}
"single" {return tt.getKeywordTokenType(252);}
"some" {return tt.getKeywordTokenType(253);}
"space" {return tt.getKeywordTokenType(254);}
"sql" {return tt.getKeywordTokenType(255);}
"sqlcode" {return tt.getKeywordTokenType(256);}
"sqlerrm" {return tt.getKeywordTokenType(257);}
"start" {return tt.getKeywordTokenType(258);}
"statistic" {return tt.getKeywordTokenType(259);}
"submultiset" {return tt.getKeywordTokenType(260);}
"subpartition" {return tt.getKeywordTokenType(261);}
"subtype" {return tt.getKeywordTokenType(262);}
"successful" {return tt.getKeywordTokenType(263);}
"sum_squares_between" {return tt.getKeywordTokenType(264);}
"sum_squares_within" {return tt.getKeywordTokenType(265);}
"synonym" {return tt.getKeywordTokenType(266);}
"table" {return tt.getKeywordTokenType(267);}
"then" {return tt.getKeywordTokenType(268);}
"time" {return tt.getKeywordTokenType(269);}
"timezone_abbr" {return tt.getKeywordTokenType(270);}
"timezone_hour" {return tt.getKeywordTokenType(271);}
"timezone_minute" {return tt.getKeywordTokenType(272);}
"timezone_region" {return tt.getKeywordTokenType(273);}
"to" {return tt.getKeywordTokenType(274);}
"trailing" {return tt.getKeywordTokenType(275);}
"transaction" {return tt.getKeywordTokenType(276);}
"trigger" {return tt.getKeywordTokenType(277);}
"trust" {return tt.getKeywordTokenType(278);}
"two_sided_prob" {return tt.getKeywordTokenType(279);}
"two_sided_sig" {return tt.getKeywordTokenType(280);}
"type" {return tt.getKeywordTokenType(281);}
"u_statistic" {return tt.getKeywordTokenType(282);}
"unbounded" {return tt.getKeywordTokenType(283);}
"under_path" {return tt.getKeywordTokenType(284);}
"union" {return tt.getKeywordTokenType(285);}
"unique" {return tt.getKeywordTokenType(286);}
"unlimited" {return tt.getKeywordTokenType(287);}
"until" {return tt.getKeywordTokenType(288);}
"update" {return tt.getKeywordTokenType(289);}
"updated" {return tt.getKeywordTokenType(290);}
"upsert" {return tt.getKeywordTokenType(291);}
"use" {return tt.getKeywordTokenType(292);}
"user" {return tt.getKeywordTokenType(293);}
"using" {return tt.getKeywordTokenType(294);}
"validate" {return tt.getKeywordTokenType(295);}
"value" {return tt.getKeywordTokenType(296);}
"values" {return tt.getKeywordTokenType(297);}
"varray" {return tt.getKeywordTokenType(298);}
"varying" {return tt.getKeywordTokenType(299);}
"versions" {return tt.getKeywordTokenType(300);}
"view" {return tt.getKeywordTokenType(301);}
"wait" {return tt.getKeywordTokenType(302);}
"when" {return tt.getKeywordTokenType(303);}
"whenever" {return tt.getKeywordTokenType(304);}
"where" {return tt.getKeywordTokenType(305);}
"while" {return tt.getKeywordTokenType(306);}
"with" {return tt.getKeywordTokenType(307);}
"within" {return tt.getKeywordTokenType(308);}
"wnds" {return tt.getKeywordTokenType(309);}
"wnps" {return tt.getKeywordTokenType(310);}
"work" {return tt.getKeywordTokenType(311);}
"write" {return tt.getKeywordTokenType(312);}
"year" {return tt.getKeywordTokenType(313);}
"zone" {return tt.getKeywordTokenType(314);}
"false" {return tt.getKeywordTokenType(315);}
"true" {return tt.getKeywordTokenType(316);}
