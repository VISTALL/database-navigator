...
"exclusive" {return tt.getKeywordTokenType(84);}
"execute" {return tt.getKeywordTokenType(85);}
"exists" {return tt.getKeywordTokenType(86);}
"exit" {return tt.getKeywordTokenType(87);}
"extend" {return tt.getKeywordTokenType(88);}
"extends" {return tt.getKeywordTokenType(89);}
"f_ratio" {return tt.getKeywordTokenType(90);}
"fetch" {return tt.getKeywordTokenType(91);}
"first" {return tt.getKeywordTokenType(92);}
"following" {return tt.getKeywordTokenType(93);}
"for" {return tt.getKeywordTokenType(94);}
"forall" {return tt.getKeywordTokenType(95);}
"found" {return tt.getKeywordTokenType(96);}
"from" {return tt.getKeywordTokenType(97);}
"full" {return tt.getKeywordTokenType(98);}
"function" {return tt.getKeywordTokenType(99);}
"goto" {return tt.getKeywordTokenType(100);}
"group" {return tt.getKeywordTokenType(101);}
"having" {return tt.getKeywordTokenType(102);}
"heap" {return tt.getKeywordTokenType(103);}
"hour" {return tt.getKeywordTokenType(104);}
"if" {return tt.getKeywordTokenType(105);}
"ignore" {return tt.getKeywordTokenType(106);}
"immediate" {return tt.getKeywordTokenType(107);}
"in" {return tt.getKeywordTokenType(108);}
"in"{ws}"out" {return tt.getKeywordTokenType(109);}
"increment" {return tt.getKeywordTokenType(110);}
"index" {return tt.getKeywordTokenType(111);}
"indicator" {return tt.getKeywordTokenType(112);}
"infinite" {return tt.getKeywordTokenType(113);}
"inner" {return tt.getKeywordTokenType(114);}
"insert" {return tt.getKeywordTokenType(115);}
"interface" {return tt.getKeywordTokenType(116);}
"intersect" {return tt.getKeywordTokenType(117);}
"interval" {return tt.getKeywordTokenType(118);}
"into" {return tt.getKeywordTokenType(119);}
"is" {return tt.getKeywordTokenType(120);}
"isolation" {return tt.getKeywordTokenType(121);}
"isopen" {return tt.getKeywordTokenType(122);}
"iterate" {return tt.getKeywordTokenType(123);}
"java" {return tt.getKeywordTokenType(124);}
"join" {return tt.getKeywordTokenType(125);}
"keep" {return tt.getKeywordTokenType(126);}
"last" {return tt.getKeywordTokenType(127);}
"leading" {return tt.getKeywordTokenType(128);}
"left" {return tt.getKeywordTokenType(129);}
"level" {return tt.getKeywordTokenType(130);}
"like" {return tt.getKeywordTokenType(131);}
"like2" {return tt.getKeywordTokenType(132);}
"like4" {return tt.getKeywordTokenType(133);}
"likec" {return tt.getKeywordTokenType(134);}
"limit" {return tt.getKeywordTokenType(135);}
"limited" {return tt.getKeywordTokenType(136);}
"lock" {return tt.getKeywordTokenType(137);}
"log" {return tt.getKeywordTokenType(138);}
"loop" {return tt.getKeywordTokenType(139);}
"main" {return tt.getKeywordTokenType(140);}
"matched" {return tt.getKeywordTokenType(141);}
"maxvalue" {return tt.getKeywordTokenType(142);}
"mean_squares_between" {return tt.getKeywordTokenType(143);}
"mean_squares_within" {return tt.getKeywordTokenType(144);}
"measures" {return tt.getKeywordTokenType(145);}
"member" {return tt.getKeywordTokenType(146);}
"merge" {return tt.getKeywordTokenType(147);}
"minus" {return tt.getKeywordTokenType(148);}
"minute" {return tt.getKeywordTokenType(149);}
"minvalue" {return tt.getKeywordTokenType(150);}
"mlslabel" {return tt.getKeywordTokenType(151);}
"mode" {return tt.getKeywordTokenType(152);}
"model" {return tt.getKeywordTokenType(153);}
"month" {return tt.getKeywordTokenType(154);}
"multiset" {return tt.getKeywordTokenType(155);}
"name" {return tt.getKeywordTokenType(156);}
"nan" {return tt.getKeywordTokenType(157);}
"natural" {return tt.getKeywordTokenType(158);}
"naturaln" {return tt.getKeywordTokenType(159);}
"nav" {return tt.getKeywordTokenType(160);}
"nchar_cs" {return tt.getKeywordTokenType(161);}
"new" {return tt.getKeywordTokenType(162);}
"next" {return tt.getKeywordTokenType(163);}
"nextval" {return tt.getKeywordTokenType(164);}
"nocopy" {return tt.getKeywordTokenType(165);}
"nocycle" {return tt.getKeywordTokenType(166);}
"not" {return tt.getKeywordTokenType(167);}
"notfound" {return tt.getKeywordTokenType(168);}
"nowait" {return tt.getKeywordTokenType(169);}
"null" {return tt.getKeywordTokenType(170);}
"nulls" {return tt.getKeywordTokenType(171);}
"number_base" {return tt.getKeywordTokenType(172);}
"ocirowid" {return tt.getKeywordTokenType(173);}
"of" {return tt.getKeywordTokenType(174);}
"on" {return tt.getKeywordTokenType(175);}
"one_sided_prob_or_less" {return tt.getKeywordTokenType(176);}
"one_sided_prob_or_more" {return tt.getKeywordTokenType(177);}
"one_sided_sig" {return tt.getKeywordTokenType(178);}
"only" {return tt.getKeywordTokenType(179);}
"opaque" {return tt.getKeywordTokenType(180);}
"open" {return tt.getKeywordTokenType(181);}
"operator" {return tt.getKeywordTokenType(182);}
"option" {return tt.getKeywordTokenType(183);}
"or" {return tt.getKeywordTokenType(184);}
"order" {return tt.getKeywordTokenType(185);}
"organization" {return tt.getKeywordTokenType(186);}
"others" {return tt.getKeywordTokenType(187);}
"out" {return tt.getKeywordTokenType(188);}
"outer" {return tt.getKeywordTokenType(189);}
"over" {return tt.getKeywordTokenType(190);}
"package" {return tt.getKeywordTokenType(191);}
"parallel_enable" {return tt.getKeywordTokenType(192);}
"partition" {return tt.getKeywordTokenType(193);}
"pctfree" {return tt.getKeywordTokenType(194);}
"phi_coefficient" {return tt.getKeywordTokenType(195);}
"positive" {return tt.getKeywordTokenType(196);}
"positiven" {return tt.getKeywordTokenType(197);}
"power" {return tt.getKeywordTokenType(198);}
"pragma" {return tt.getKeywordTokenType(199);}
"preceding" {return tt.getKeywordTokenType(200);}
"present" {return tt.getKeywordTokenType(201);}
"prior" {return tt.getKeywordTokenType(202);}
"private" {return tt.getKeywordTokenType(203);}
"procedure" {return tt.getKeywordTokenType(204);}
"public" {return tt.getKeywordTokenType(205);}
"raise" {return tt.getKeywordTokenType(206);}
"range" {return tt.getKeywordTokenType(207);}
"rank" {return tt.getKeywordTokenType(208);}
"read" {return tt.getKeywordTokenType(209);}
"record" {return tt.getKeywordTokenType(210);}
"ref" {return tt.getKeywordTokenType(211);}
"reference" {return tt.getKeywordTokenType(212);}
"regexp_like" {return tt.getKeywordTokenType(213);}
"release" {return tt.getKeywordTokenType(214);}
"remainder" {return tt.getKeywordTokenType(215);}
"replace" {return tt.getKeywordTokenType(216);}
"restrict_references" {return tt.getKeywordTokenType(217);}
"return" {return tt.getKeywordTokenType(218);}
"returning" {return tt.getKeywordTokenType(219);}
"reject" {return tt.getKeywordTokenType(220);}
"reverse" {return tt.getKeywordTokenType(221);}
"right" {return tt.getKeywordTokenType(222);}
"rnds" {return tt.getKeywordTokenType(223);}
"rnps" {return tt.getKeywordTokenType(224);}
"rollback" {return tt.getKeywordTokenType(225);}
"rollup" {return tt.getKeywordTokenType(226);}
"row" {return tt.getKeywordTokenType(227);}
"rowcount" {return tt.getKeywordTokenType(228);}
"rownum" {return tt.getKeywordTokenType(229);}
"rows" {return tt.getKeywordTokenType(230);}
"rowtype" {return tt.getKeywordTokenType(231);}
"rules" {return tt.getKeywordTokenType(232);}
"sample" {return tt.getKeywordTokenType(233);}
"savepoint" {return tt.getKeywordTokenType(234);}
"scn" {return tt.getKeywordTokenType(235);}
"second" {return tt.getKeywordTokenType(236);}
"seed" {return tt.getKeywordTokenType(237);}
"segment" {return tt.getKeywordTokenType(238);}
"select" {return tt.getKeywordTokenType(239);}
"separate" {return tt.getKeywordTokenType(240);}
"sequential" {return tt.getKeywordTokenType(241);}
"serializable" {return tt.getKeywordTokenType(242);}
"serially_reusable" {return tt.getKeywordTokenType(243);}
"set" {return tt.getKeywordTokenType(244);}
"sets" {return tt.getKeywordTokenType(245);}
"share" {return tt.getKeywordTokenType(246);}
"siblings" {return tt.getKeywordTokenType(247);}
"sig" {return tt.getKeywordTokenType(248);}
"single" {return tt.getKeywordTokenType(249);}
"some" {return tt.getKeywordTokenType(250);}
"space" {return tt.getKeywordTokenType(251);}
"sql" {return tt.getKeywordTokenType(252);}
"sqlcode" {return tt.getKeywordTokenType(253);}
"sqlerrm" {return tt.getKeywordTokenType(254);}
"start" {return tt.getKeywordTokenType(255);}
"statistic" {return tt.getKeywordTokenType(256);}
"submultiset" {return tt.getKeywordTokenType(257);}
"subpartition" {return tt.getKeywordTokenType(258);}
"subtype" {return tt.getKeywordTokenType(259);}
"successful" {return tt.getKeywordTokenType(260);}
"sum_squares_between" {return tt.getKeywordTokenType(261);}
"sum_squares_within" {return tt.getKeywordTokenType(262);}
"synonym" {return tt.getKeywordTokenType(263);}
"table" {return tt.getKeywordTokenType(264);}
"then" {return tt.getKeywordTokenType(265);}
"time" {return tt.getKeywordTokenType(266);}
"timezone_abbr" {return tt.getKeywordTokenType(267);}
"timezone_hour" {return tt.getKeywordTokenType(268);}
"timezone_minute" {return tt.getKeywordTokenType(269);}
"timezone_region" {return tt.getKeywordTokenType(270);}
"to" {return tt.getKeywordTokenType(271);}
"trailing" {return tt.getKeywordTokenType(272);}
"transaction" {return tt.getKeywordTokenType(273);}
"trigger" {return tt.getKeywordTokenType(274);}
"trust" {return tt.getKeywordTokenType(275);}
"two_sided_prob" {return tt.getKeywordTokenType(276);}
"two_sided_sig" {return tt.getKeywordTokenType(277);}
"type" {return tt.getKeywordTokenType(278);}
"u_statistic" {return tt.getKeywordTokenType(279);}
"unbounded" {return tt.getKeywordTokenType(280);}
"under_path" {return tt.getKeywordTokenType(281);}
"union" {return tt.getKeywordTokenType(282);}
"unique" {return tt.getKeywordTokenType(283);}
"unlimited" {return tt.getKeywordTokenType(284);}
"until" {return tt.getKeywordTokenType(285);}
"update" {return tt.getKeywordTokenType(286);}
"updated" {return tt.getKeywordTokenType(287);}
"upsert" {return tt.getKeywordTokenType(288);}
"use" {return tt.getKeywordTokenType(289);}
"user" {return tt.getKeywordTokenType(290);}
"using" {return tt.getKeywordTokenType(291);}
"validate" {return tt.getKeywordTokenType(292);}
"value" {return tt.getKeywordTokenType(293);}
"values" {return tt.getKeywordTokenType(294);}
"varray" {return tt.getKeywordTokenType(295);}
"varying" {return tt.getKeywordTokenType(296);}
"versions" {return tt.getKeywordTokenType(297);}
"view" {return tt.getKeywordTokenType(298);}
"wait" {return tt.getKeywordTokenType(299);}
"when" {return tt.getKeywordTokenType(300);}
"whenever" {return tt.getKeywordTokenType(301);}
"where" {return tt.getKeywordTokenType(302);}
"while" {return tt.getKeywordTokenType(303);}
"with" {return tt.getKeywordTokenType(304);}
"within" {return tt.getKeywordTokenType(305);}
"wnds" {return tt.getKeywordTokenType(306);}
"wnps" {return tt.getKeywordTokenType(307);}
"work" {return tt.getKeywordTokenType(308);}
"write" {return tt.getKeywordTokenType(309);}
"year" {return tt.getKeywordTokenType(310);}
"zone" {return tt.getKeywordTokenType(311);}
"false" {return tt.getKeywordTokenType(312);}
"true" {return tt.getKeywordTokenType(313);}
