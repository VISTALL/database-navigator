...
public interface DataGridTextAttributesKeys {
    ...
    Color DEFAULT_FOREIGN_REFERENCE_BG_COLOR = new Color(250, 253, 255);
    ...
    TextAttributesKey FOREIGN_REFERENCE = TextAttributesKey.createTextAttributesKey("DBNavigator.TextAttributes.DataEditor.ForeignReference",  new TextAttributes(DEFAULT_FOREIGN_REFERENCE_FG_COLOR, DEFAULT_FOREIGN_REFERENCE_BG_COLOR, null, null, SimpleTextAttributes.STYLE_PLAIN));
