...
public interface DataGridTextAttributesKeys {
    ...
    ColorKey CARET_ROW_BACKGROUND = ColorKey.createColorKey("CARET_ROW_COLOR", scheme.getColor(EditorColors.CARET_ROW_COLOR));
    ...
    TextAttributesKey PRIMARY_KEY    = TextAttributesKey.createTextAttributesKey("DBNavigator.TextAttributes.DataEditor.PrimaryKey",   new TextAttributes(DEFAULT_PRIMARY_KEY_FG_COLOR, DEFAULT_PRIMARY_KEY_BG_COLOR, null, null, SimpleTextAttributes.STYLE_BOLD));
    TextAttributesKey FOREIGN_KEY    = TextAttributesKey.createTextAttributesKey("DBNavigator.TextAttributes.DataEditor.ForeignKey",   new TextAttributes(DEFAULT_FOREIGN_KEY_FG_COLOR, DEFAULT_FOREIGN_KEY_BG_COLOR, null, null, SimpleTextAttributes.STYLE_PLAIN));
