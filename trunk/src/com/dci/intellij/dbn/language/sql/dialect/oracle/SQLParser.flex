...
"escape" {return tt.getKeywordTokenType(144);}
"exact_prob" {return tt.getKeywordTokenType(145);}
"exceptions" {return tt.getKeywordTokenType(146);}
"exchange" {return tt.getKeywordTokenType(147);}
"excluding" {return tt.getKeywordTokenType(148);}
"exclusive" {return tt.getKeywordTokenType(149);}
"exists" {return tt.getKeywordTokenType(150);}
"expire" {return tt.getKeywordTokenType(151);}
"extent" {return tt.getKeywordTokenType(152);}
"externally" {return tt.getKeywordTokenType(153);}
"f_ratio" {return tt.getKeywordTokenType(154);}
"failed" {return tt.getKeywordTokenType(155);}
"failgroup" {return tt.getKeywordTokenType(156);}
"fast" {return tt.getKeywordTokenType(157);}
"file" {return tt.getKeywordTokenType(158);}
"fine" {return tt.getKeywordTokenType(159);}
"finish" {return tt.getKeywordTokenType(160);}
"first" {return tt.getKeywordTokenType(161);}
"flashback" {return tt.getKeywordTokenType(162);}
"flush" {return tt.getKeywordTokenType(163);}
"following" {return tt.getKeywordTokenType(164);}
"for" {return tt.getKeywordTokenType(165);}
"force" {return tt.getKeywordTokenType(166);}
"foreign" {return tt.getKeywordTokenType(167);}
"freelist" {return tt.getKeywordTokenType(168);}
"freelists" {return tt.getKeywordTokenType(169);}
"freepools" {return tt.getKeywordTokenType(170);}
"fresh" {return tt.getKeywordTokenType(171);}
"from" {return tt.getKeywordTokenType(172);}
"full" {return tt.getKeywordTokenType(173);}
"function" {return tt.getKeywordTokenType(174);}
"g" {return tt.getKeywordTokenType(175);}
...
"having" {return tt.getKeywordTokenType(183);}
"hierarchy" {return tt.getKeywordTokenType(184);}
"history" {return tt.getKeywordTokenType(185);}
"hour" {return tt.getKeywordTokenType(186);}
"id" {return tt.getKeywordTokenType(187);}
"identified" {return tt.getKeywordTokenType(188);}
"identifier" {return tt.getKeywordTokenType(189);}
"ignore" {return tt.getKeywordTokenType(190);}
"immediate" {return tt.getKeywordTokenType(191);}
"in" {return tt.getKeywordTokenType(192);}
"including" {return tt.getKeywordTokenType(193);}
"increment" {return tt.getKeywordTokenType(194);}
"index" {return tt.getKeywordTokenType(195);}
"indexes" {return tt.getKeywordTokenType(196);}
"indextype" {return tt.getKeywordTokenType(197);}
"infinite" {return tt.getKeywordTokenType(198);}
"initial" {return tt.getKeywordTokenType(199);}
"initially" {return tt.getKeywordTokenType(200);}
"initrans" {return tt.getKeywordTokenType(201);}
"inner" {return tt.getKeywordTokenType(202);}
"insert" {return tt.getKeywordTokenType(203);}
"instance" {return tt.getKeywordTokenType(204);}
"intermediate" {return tt.getKeywordTokenType(205);}
"intersect" {return tt.getKeywordTokenType(206);}
"into" {return tt.getKeywordTokenType(207);}
"invalidate" {return tt.getKeywordTokenType(208);}
"is" {return tt.getKeywordTokenType(209);}
"iterate" {return tt.getKeywordTokenType(210);}
"java" {return tt.getKeywordTokenType(211);}
"join" {return tt.getKeywordTokenType(212);}
"k" {return tt.getKeywordTokenType(213);}
...
"m" {return tt.getKeywordTokenType(238);}
"main" {return tt.getKeywordTokenType(239);}
"managed" {return tt.getKeywordTokenType(240);}
"manual" {return tt.getKeywordTokenType(241);}
"mapping" {return tt.getKeywordTokenType(242);}
"master" {return tt.getKeywordTokenType(243);}
...
"rely" {return tt.getKeywordTokenType(371);}
"rename" {return tt.getKeywordTokenType(372);}
"repair" {return tt.getKeywordTokenType(373);}
"replace" {return tt.getKeywordTokenType(374);}
"reset" {return tt.getKeywordTokenType(375);}
"resetlogs" {return tt.getKeywordTokenType(376);}
"resize" {return tt.getKeywordTokenType(377);}
"resolve" {return tt.getKeywordTokenType(378);}
"resolver" {return tt.getKeywordTokenType(379);}
"resource" {return tt.getKeywordTokenType(380);}
"restrict" {return tt.getKeywordTokenType(381);}
"restricted" {return tt.getKeywordTokenType(382);}
"resumable" {return tt.getKeywordTokenType(383);}
"resume" {return tt.getKeywordTokenType(384);}
"retention" {return tt.getKeywordTokenType(385);}
"return" {return tt.getKeywordTokenType(386);}
"returning" {return tt.getKeywordTokenType(387);}
"reuse" {return tt.getKeywordTokenType(388);}
"reverse" {return tt.getKeywordTokenType(389);}
"revoke" {return tt.getKeywordTokenType(390);}
"rewrite" {return tt.getKeywordTokenType(391);}
"right" {return tt.getKeywordTokenType(392);}
"role" {return tt.getKeywordTokenType(393);}
"rollback" {return tt.getKeywordTokenType(394);}
"rollup" {return tt.getKeywordTokenType(395);}
"row" {return tt.getKeywordTokenType(396);}
"rownum" {return tt.getKeywordTokenType(397);}
"rows" {return tt.getKeywordTokenType(398);}
"rules" {return tt.getKeywordTokenType(399);}
"sample" {return tt.getKeywordTokenType(400);}
"savepoint" {return tt.getKeywordTokenType(401);}
"scan" {return tt.getKeywordTokenType(402);}
"scn" {return tt.getKeywordTokenType(403);}
"scope" {return tt.getKeywordTokenType(404);}
"second" {return tt.getKeywordTokenType(405);}
"seed" {return tt.getKeywordTokenType(406);}
"segment" {return tt.getKeywordTokenType(407);}
"select" {return tt.getKeywordTokenType(408);}
"sequence" {return tt.getKeywordTokenType(409);}
"sequential" {return tt.getKeywordTokenType(410);}
"serializable" {return tt.getKeywordTokenType(411);}
"session" {return tt.getKeywordTokenType(412);}
"set" {return tt.getKeywordTokenType(413);}
"sets" {return tt.getKeywordTokenType(414);}
"settings" {return tt.getKeywordTokenType(415);}
"share" {return tt.getKeywordTokenType(416);}
"shared_pool" {return tt.getKeywordTokenType(417);}
"shrink" {return tt.getKeywordTokenType(418);}
"shutdown" {return tt.getKeywordTokenType(419);}
"siblings" {return tt.getKeywordTokenType(420);}
"sid" {return tt.getKeywordTokenType(421);}
"sig" {return tt.getKeywordTokenType(422);}
"single" {return tt.getKeywordTokenType(423);}
"size" {return tt.getKeywordTokenType(424);}
"skip" {return tt.getKeywordTokenType(425);}
"smallfile" {return tt.getKeywordTokenType(426);}
"some" {return tt.getKeywordTokenType(427);}
"sort" {return tt.getKeywordTokenType(428);}
"source" {return tt.getKeywordTokenType(429);}
"space" {return tt.getKeywordTokenType(430);}
"specification" {return tt.getKeywordTokenType(431);}
"spfile" {return tt.getKeywordTokenType(432);}
"split" {return tt.getKeywordTokenType(433);}
"standby" {return tt.getKeywordTokenType(434);}
"start" {return tt.getKeywordTokenType(435);}
"statistic" {return tt.getKeywordTokenType(436);}
"statistics" {return tt.getKeywordTokenType(437);}
"stop" {return tt.getKeywordTokenType(438);}
"storage" {return tt.getKeywordTokenType(439);}
"store" {return tt.getKeywordTokenType(440);}
"submultiset" {return tt.getKeywordTokenType(441);}
"subpartition" {return tt.getKeywordTokenType(442);}
"subpartitions" {return tt.getKeywordTokenType(443);}
"substitutable" {return tt.getKeywordTokenType(444);}
"successful" {return tt.getKeywordTokenType(445);}
"sum_squares_between" {return tt.getKeywordTokenType(446);}
"sum_squares_within" {return tt.getKeywordTokenType(447);}
"supplemental" {return tt.getKeywordTokenType(448);}
"suspend" {return tt.getKeywordTokenType(449);}
"switch" {return tt.getKeywordTokenType(450);}
"switchover" {return tt.getKeywordTokenType(451);}
"synonym" {return tt.getKeywordTokenType(452);}
"system" {return tt.getKeywordTokenType(453);}
"t" {return tt.getKeywordTokenType(454);}
"table" {return tt.getKeywordTokenType(455);}
"tables" {return tt.getKeywordTokenType(456);}
"tablespace" {return tt.getKeywordTokenType(457);}
"tempfile" {return tt.getKeywordTokenType(458);}
"template" {return tt.getKeywordTokenType(459);}
"temporary" {return tt.getKeywordTokenType(460);}
"test" {return tt.getKeywordTokenType(461);}
"than" {return tt.getKeywordTokenType(462);}
"then" {return tt.getKeywordTokenType(463);}
"thread" {return tt.getKeywordTokenType(464);}
"through" {return tt.getKeywordTokenType(465);}
"time" {return tt.getKeywordTokenType(466);}
"time_zone" {return tt.getKeywordTokenType(467);}
"timeout" {return tt.getKeywordTokenType(468);}
"timezone_abbr" {return tt.getKeywordTokenType(469);}
"timezone_hour" {return tt.getKeywordTokenType(470);}
"timezone_minute" {return tt.getKeywordTokenType(471);}
"timezone_region" {return tt.getKeywordTokenType(472);}
"to" {return tt.getKeywordTokenType(473);}
"trace" {return tt.getKeywordTokenType(474);}
"tracking" {return tt.getKeywordTokenType(475);}
"trailing" {return tt.getKeywordTokenType(476);}
"transaction" {return tt.getKeywordTokenType(477);}
"trigger" {return tt.getKeywordTokenType(478);}
"truncate" {return tt.getKeywordTokenType(479);}
"trusted" {return tt.getKeywordTokenType(480);}
"two_sided_prob" {return tt.getKeywordTokenType(481);}
"two_sided_sig" {return tt.getKeywordTokenType(482);}
"type" {return tt.getKeywordTokenType(483);}
"u_statistic" {return tt.getKeywordTokenType(484);}
"uid" {return tt.getKeywordTokenType(485);}
"unarchived" {return tt.getKeywordTokenType(486);}
"unbounded" {return tt.getKeywordTokenType(487);}
"under" {return tt.getKeywordTokenType(488);}
"under_path" {return tt.getKeywordTokenType(489);}
"undrop" {return tt.getKeywordTokenType(490);}
"union" {return tt.getKeywordTokenType(491);}
"unique" {return tt.getKeywordTokenType(492);}
"unlimited" {return tt.getKeywordTokenType(493);}
"unprotected" {return tt.getKeywordTokenType(494);}
"unquiesce" {return tt.getKeywordTokenType(495);}
"unrecoverable" {return tt.getKeywordTokenType(496);}
"until" {return tt.getKeywordTokenType(497);}
"unusable" {return tt.getKeywordTokenType(498);}
"unused" {return tt.getKeywordTokenType(499);}
"update" {return tt.getKeywordTokenType(500);}
"updated" {return tt.getKeywordTokenType(501);}
"upgrade" {return tt.getKeywordTokenType(502);}
"upsert" {return tt.getKeywordTokenType(503);}
"usage" {return tt.getKeywordTokenType(504);}
"user" {return tt.getKeywordTokenType(505);}
"using" {return tt.getKeywordTokenType(506);}
"validate" {return tt.getKeywordTokenType(507);}
"validation" {return tt.getKeywordTokenType(508);}
"value" {return tt.getKeywordTokenType(509);}
"values" {return tt.getKeywordTokenType(510);}
"varray" {return tt.getKeywordTokenType(511);}
"versions" {return tt.getKeywordTokenType(512);}
"view" {return tt.getKeywordTokenType(513);}
"wait" {return tt.getKeywordTokenType(514);}
"when" {return tt.getKeywordTokenType(515);}
"whenever" {return tt.getKeywordTokenType(516);}
"where" {return tt.getKeywordTokenType(517);}
"with" {return tt.getKeywordTokenType(518);}
"within" {return tt.getKeywordTokenType(519);}
"without" {return tt.getKeywordTokenType(520);}
"work" {return tt.getKeywordTokenType(521);}
"write" {return tt.getKeywordTokenType(522);}
"year" {return tt.getKeywordTokenType(523);}
"zone" {return tt.getKeywordTokenType(524);}
"false" {return tt.getKeywordTokenType(525);}
"true" {return tt.getKeywordTokenType(526);}
"xmlschema" {return tt.getKeywordTokenType(527);}
"xmltype" {return tt.getKeywordTokenType(528);}
...
"remainder"{wso}"(" { yybegin(YYINITIAL); yypushback(1); return tt.getFunctionTokenType(132);}
...
"set"{wso}"(" { yybegin(YYINITIAL); yypushback(1); return tt.getFunctionTokenType(141);}
...
"uid"{wso}"(" { yybegin(YYINITIAL); yypushback(1); return tt.getFunctionTokenType(201);}
"unique"{wso}"(" { yybegin(YYINITIAL); yypushback(1); return tt.getFunctionTokenType(202);}
...
"user"{wso}"(" { yybegin(YYINITIAL); yypushback(1); return tt.getFunctionTokenType(206);}
"userenv" {return tt.getFunctionTokenType(207);}
"value"{wso}"(" { yybegin(YYINITIAL); yypushback(1); return tt.getFunctionTokenType(208);}
...
"xmlsequence" {return tt.getFunctionTokenType(218);}
"xmltransform" {return tt.getFunctionTokenType(219);}
