...
public class ObjectLookupAdapter extends IdentifierLookupAdapter {
    ...
    public ObjectLookupAdapter(LeafPsiElement lookupIssuer, DBObjectType objectType, String identifierName) {
    ...
    public ObjectLookupAdapter(LeafPsiElement lookupIssuer, IdentifierRole identifierRole, DBObjectType objectType, String identifierName) {
        super(lookupIssuer, IdentifierType.OBJECT, identifierRole, objectType, identifierName);
    }

    public ObjectLookupAdapter(LeafPsiElement lookupIssuer, @Nullable IdentifierRole identifierRole, @NotNull DBObjectType objectType, String identifierName, ElementTypeAttribute attribute) {
