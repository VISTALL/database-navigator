...
public class ChameleonTokenType extends ILazyParseableElementType implements ElementType, TokenType {
    public ChameleonTokenType(DBLanguageDialect language) {
