...
public class SimpleObjectLookupAdapter extends IdentifierLookupAdapter {
    ...
    public SimpleObjectLookupAdapter(LeafPsiElement lookupIssuer, DBObjectType objectType, String identifierName) {
    ...
    public SimpleObjectLookupAdapter(LeafPsiElement lookupIssuer, IdentifierRole identifierRole, DBObjectType objectType, String identifierName) {
        super(lookupIssuer, IdentifierType.OBJECT, identifierRole, objectType, identifierName);
    }

    public SimpleObjectLookupAdapter(LeafPsiElement lookupIssuer, @Nullable IdentifierRole identifierRole, @NotNull DBObjectType objectType, String identifierName, ElementTypeAttribute attribute) {
